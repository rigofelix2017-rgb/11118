...
export function MobileControls({
  ...
  const getMovementDirection = useCallback((deltaX: number, deltaY: number, maxDistance: number) => {
    ...
    // Based on the existing keyboard controls:
  ...
  // Don't render on desktop or when bottom tabs are active
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-20">
      ...
      <div className="absolute bottom-20 left-6 pointer-events-auto">
        {/* Joystick Housing */}
        <div className="vintage-panel-raised p-2 rounded-full" style={{
        ...
        <div className="text-center mt-3 text-xs font-mono font-bold tracking-wider vintage-glow-text"
          style={{
            color: '#00ffff',
      ...
      <div className="absolute bottom-20 right-6 pointer-events-auto">
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            onTouchStart={(e) => handleTouchStart(e, onRingBlast)}
            data-testid="button-ring-blast"
          >
